 ...
 */
    ...
    public boolean guardar_horario(String name, String datos) throws IOException{
        String destino = "ArchivosExternos/horarios_guardados/Entorno/" + name;
        String origen = "ArchivosExternos/" + datos;
    ...
    public boolean cargar_horario(String name) {
        String ruta = "ArchivosExternos/horarios_guardados/Entorno/" + name;
